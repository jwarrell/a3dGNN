# modified from https://diveintographs.readthedocs.io/en/latest/_modules/dig/threedgraph/method/dimenetpp/dimenetpp.html#DimeNetPP.forward
...
from dig.threedgraph.method.dimenetpp.features import dist_emb, angle_emb
...
class init(torch.nn.Module):
    def __init__(self, input_feature_dim, num_radial, hidden_channels, act=swish):
        super(init, self).__init__()
        self.act = act
        # self.emb = Embedding(95, hidden_channels)
        self.emb = nn.Linear(input_feature_dim, hidden_channels)
...
class DimeNetPP(torch.nn.Module):
    ...
    def __init__(
            self, input_feature_dim, energy_and_force=False, cutoff=5.0, num_layers=4,
        ...
        self.init_e = init(input_feature_dim=input_feature_dim,
